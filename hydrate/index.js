...
const NAMESPACE = 'cms-web-components';
const BUILD = /* cms-web-components */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: false, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: false, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: false, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: false, propMutable: false, propNumber: false, propString: true, reflect: false, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: false, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: false, vdomListener: false, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false, watchCallback: false };
...
function transformRichTextHeader(richTextNode, classNames = '') {
  if (!richTextNode)
    return '';
  const headings = {};
  new Array(6).fill('').forEach((_item, index) => {
    const tag = `h${index + 1}`;
    headings[`heading-${index + 1}`] = (headerNode, next) => {
  ...
  const options = {
    renderNode: Object.assign({}, headings)
  };
  return richTextHtmlRenderer_es5.documentToHtmlString(richTextNode, options);
}

const mediaBoxCss = "/*!@:host*/.sc-media-box-h{display:block}/*!@.media-box-wrapper*/.media-box-wrapper.sc-media-box{display:flex;align-items:center;max-width:1200px;margin:auto}/*!@.media-box-wrapper.media-box-reverse*/.media-box-wrapper.media-box-reverse.sc-media-box{flex-direction:row-reverse}/*!@.media-box-element*/.media-box-element.sc-media-box{display:flex;flex-direction:column;flex:1;padding:0 24px 0 12px;font-size:18px}/*!@.media-box-image*/.media-box-image.sc-media-box{width:auto;height:auto;max-height:520px;max-width:100%;margin:0 auto}/*!@.media-box-element-title*/.media-box-element-title.sc-media-box{margin:0 0 16px;font-family:font-semibold;font-size:36px;font-weight:400;color:#01051C;line-height:48px}/*!@.media-box-element-desc*/.media-box-element-desc.sc-media-box{margin:0 0 32px;font-family:font-Regular;font-size:16px;font-weight:400;line-height:24px;color:rgba(32,49,81,.7)}@media only screen and (max-width: 768px){/*!@.media-box-wrapper, .media-box-wrapper.media-box-reverse*/.media-box-wrapper.sc-media-box,.media-box-wrapper.media-box-reverse.sc-media-box{flex-direction:column}/*!@.media-box-element-title*/.media-box-element-title.sc-media-box{margin:32px 0 12px;font-size:28px;line-height:36px}}@media only screen and (min-width: 1200px){/*!@.media-box-element*/.media-box-element.sc-media-box{flex-basis:58%}/*!@.media-box-element.text-content*/.media-box-element.text-content.sc-media-box{flex-basis:42%}}";
...
class MediaBox {
  ...
  render() {
    ...
    return (hAsync("section", { class: `media-box-wrapper ${mediaDirectionClass}` }, hAsync("div", { class: "media-box-element" }, hAsync("img", { class: "media-box-image", src: this.imageSource, alt: this.imageAltText })), hAsync("div", { class: "media-box-element text-content" }, hAsync("div", { innerHTML: transformRichTextHeader(this.sectionTitle, 'media-box-element-title') }), hAsync("p", { class: "media-box-element-desc" }, this.sectionDescription), hAsync("slot", null))));
  }
  static get style() { return mediaBoxCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "media-box",
    "$members$": {
      "sectionTitle": [16],
      "sectionDescription": [1, "section-description"],
      "imageSource": [1, "image-source"],
      "imageAltText": [1, "image-alt-text"],
      "imageOrientation": [1, "image-orientation"]
    },
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
